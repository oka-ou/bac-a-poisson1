<?php ob_start(); // On met en memoire tampon tout ce qui devrait etre affiche
session_start();
$title = "La pisciculture" // le titre
?>
...
<?php $contenu = ob_get_clean();//On copie le contenu de la memoire tampon ds variable $contenu
//require "template/gabarit.php";// va acceder au fichier qui ce trouve à ce chemin 
